...
export const metadata: Metadata = (() => {
  ...
  return {
    title: cfg ? `Shop ${cfg.name}` : 'Shop',
    description: cfg ? `Browse ${cfg.name} with deals, best sellers, and intent-based picks.` : 'Browse our menu with deals, best sellers, and intent-based picks.',
  }
})()
