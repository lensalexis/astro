...
export default async function ResourceArticlePage({
  ...
  const crumbs = withHome([
    ...
    { name: resource.metadata.title || slug, href: `/learn/resources/${slug}` },
  ])
  ...
  const canonicalUrl = `${site.url}/learn/resources/${slug}`
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div id="top" className="mx-auto max-w-6xl px-4 sm:px-6 py-10">
        {/* Desktop breadcrumb UI */}
        <div className="hidden sm:block">
          {/* Breadcrumbs component is styled for dark pages; we override here with local classes */}
